...
¡Bienvenido, {user_mention}! 🎉

¡Felicidades por tu primera publicación en **Go-Viral**! Has dado el primer paso para hacer crecer tu contenido de 𝕏 (Twitter) con nuestra comunidad.

**Recuerda lo básico:**
1.  **Valida tu post:** Reacciona con **👍** a tu propia publicación en los próximos 120 segundos.
2.  **Apoya a otros:** Antes de volver a publicar, apoya con **RT + LIKE + COMENTARIO en 𝕏** y luego reacciona con **🔥 en Discord** a las publicaciones de los demás que estén después de la tuya.
3.  **Respeta los turnos:** Espera al menos 2 publicaciones válidas de otros usuarios antes de volver a publicar.

¡Disfruta de la comunidad y haz crecer tu cuenta! 🚀
"""
